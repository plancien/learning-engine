...
define([
    ...
    wall.create(100, 400, 600, 30);                                 //Créer un mur (rajouter @5 pour la couleur)
    ...
    var superHero = heroEngine.create(config, game.canvas.context, true);   //On créer un hero standard, on lui dit true pour dire qu'il est sous gravite
    superHero.x = 100;
