...
function(eventBus,Canvas, Frames){
	return function (params){
		...
		bonusImage.src = params.bonusUrl;

		var malusImage = new Image();
		malusImage.src = params.malusImage;
		...
		function paint()
		{
			...
			ctx.drawImage(bonusImage, food.x*controleWitdh, food.y*controleWitdh, controleWitdh, controleWitdh);
			//dessine le score
