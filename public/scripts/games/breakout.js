    ...
    function draw() {
        ...
        for (i = 0; i < this.brickRow; i++) {
            for (j = 0; j < this.brickCol; j++) {
                if (bricks[i][j] == 1) {
                    createRect((j * (this.brickWidth + this.brickPadding)) + this.brickPadding, (i * (this.brickHeight + this.brickPadding)) + this.brickPadding, this.brickWidth, this.brickHeight);
                }
            }
        }
