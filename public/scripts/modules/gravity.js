define(['event_bus'], function (eventBus)
{
    function addPhysicalProperties(object, params)
    {
        ...
        object.step = params.step || 0.5; //The value that will be added to the fall speed at each frame

        object.acceleration = function()
        {
            if(object.currentFallSpeed < object.maxFallSpeed)
                object.currentFallSpeed += object.step;
        }
