        ...
        eventBus.on('init', function() {
            imgs = imgLoad({},function() {
                ...
                for (var i = bonusNames.length - 1; i >= 0; i--) {
                    imgs[bonusNames[i]] = resizeImg(imgs[bonusNames[i]],150,150,"crop", false, randomColor());
                };

                for (var i = malusNames.length - 1; i >= 0; i--) {
                    imgs[malusNames[i]] = resizeImg(imgs[malusNames[i]],150,150,"crop", false, randomColor());
                };
